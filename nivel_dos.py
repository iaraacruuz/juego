...
class NivelDos(Nivel):
    def __init__(self,pantalla: pygame.Surface,tiempo_inicio, tiempo_total):
        ...
        plataforma_imagen_3 = pygame.transform.scale(plataforma_imagen_3, tamaño_plataforma2)
        plataforma3=Plataforma(plataforma_imagen_3, 400, 460, tamaño_plataforma[0], tamaño_plataforma[1])
