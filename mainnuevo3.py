...
# Fondo  
fondo = pygame.image.load("fondos\ciudad.jpg")
...
diccionario_animaciones["quieto"]= personaje_quieto_3
diccionario_animaciones["salta"]= personaje_salta_3
diccionario_animaciones["camina_derecha"]= personaje_camina_3
diccionario_animaciones["camina_izquierda"]= personaje_camina_izquierda_3
...
diccionario_animaciones_enemigo["camina_derecha"] = enemigo_camina_derecha_3
diccionario_animaciones_enemigo["camina_izquierda"] = enemigo_camina_izquierda_3
...
while True:
    ...
    mi_personaje.detectar_colisiones(lista_plataformas)
    enemigos_group.update(PANTALLA, lista_plataformas, mi_enemigo.balas,1)
    # enemigos_group.update(PANTALLA, lista_plataformas, mi_enemigo_2.balas,1)
    mi_personaje.detectar_colisiones(lista_plataformas)
    mi_enemigo.detectar_colisiones(lista_plataformas)
